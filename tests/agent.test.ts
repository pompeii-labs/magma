...
describe('Magma Flow Connection', () => {
    it('should attempt to connect to Magma Flow when apiKey starting with "mf_" is provided', async () => {
        ...
        new TestAgent({ apiKey: 'mf_testkey' });
